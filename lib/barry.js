        ...
        var features = {},
            ...
            factory = {
                ...
                above: function (baseVal, checkVal) {
                    if(_.isNumber(baseVal) && _.isNumber(checkVal)) {
                        return baseVal >= checkVal;
                    } else if (_.isDate(baseVal) && _.isDate(checkVal)) {
                        return (new Date(baseVal)) >= (new Date(checkVal));
                    }
                    return false;
                },
            ...
            criteria = {
                ...
                has: function (dataIn, c_data) {
                    ...
                    if (hasProp && c_data.hasOwnProperty('comparison') && c_data.hasOwnProperty('value')) {
                        var type = (typeof dataIn[c_data['trait']]).toLowerCase();
                        try {
                            ...
                            barry.log("(barry) Sorry.  Barry does not have a method called barry." + type + "." + c_data['comparison']+ "()");
