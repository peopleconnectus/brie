...
console.log('======================================== :: barry - date math');
console.log("(j.corns) _.isDate('2011-10-31T13:14:29-0700')", _.isDate('2011-10-31T13:14:29-0700'));
console.log("(j.corns) _.isDate(new Date('2011-10-31T13:14:29-0700'))", _.isDate(new Date('2011-10-31T13:14:29-0700')));
console.log("(j.corns) _.isDate(new Date('test for echo'))", _.isDate(new Date('test for echo')));
console.log('======================================== :: end barry');
...
//    .knows(require('./comparitors/type'))
    ...
    .knows(require('./comparitors/date'))
